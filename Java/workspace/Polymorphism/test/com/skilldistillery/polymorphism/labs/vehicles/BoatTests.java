...
public class BoatTests {
  ...
  @Test
  public void test_calculateRegistrationFee_returns_rate_times_two_times_purchasePrice_for_length_30_or_more() {
	  Boat b = new Boat(1000, "BoatyMcBoatFace", 1000000, 40);
