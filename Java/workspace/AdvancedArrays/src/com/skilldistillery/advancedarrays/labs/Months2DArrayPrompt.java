...
//		}
	...
	public static void userPrompt(String monthsArray[][]) {
		System.out.println("Please enter your birth month.");
		String birthMonth = kb.next();
		
		for (int row = 0; row < monthsArray.length; row++) {
			for (int col = 0; col < monthsArray.length; col++) {
				if (birthMonth.equals(monthsArray[row][0])) {
					System.out.print(monthsArray[row][1]+ ", ");
					System.out.print(monthsArray[row][2]);
					break;
				}
			}
		}
