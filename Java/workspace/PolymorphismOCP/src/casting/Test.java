...
public class Test {
	public static void main(String[] args) {
		...
		//	a2.fly();	//wont compile, why? -> Animal class has no fly()
...
//		a = (Animal)s;  // doesn't compile
		...
		System.out.println("longs go up to: " + Long.MAX_VALUE);
		System.out.println("ints go up to: " + Integer.MAX_VALUE);
		System.out.println("doubles go up to: " + Double.MAX_VALUE);
		System.out.println("floats go up to: " + Float.MAX_VALUE);
		System.out.println("shorts go up to: " + Short.MAX_VALUE);
		System.out.println("bytes go up to: " + Byte.MAX_VALUE);
